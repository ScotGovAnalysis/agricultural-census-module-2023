...
# I want to store the completed tables and call them in without having to reshape and rename them each time. I am trying this: https://www.geeksforgeeks.org/how-to-read-multiple-files-parallelly-and-extract-data-in-r/
...
file_list1
#> file_list1
#[1] "Table_1_df.txt"  "Table_10_df.txt" "Table_11_df.txt" "Table_12_df.txt" "Table_13_df.txt" "Table_14_df.txt"
#[7] "Table_15_df.txt" "Table_16_df.txt" "Table_2_df.txt"  "Table_3_df.txt"  "Table_4_df.txt"  "Table_5_df.txt" 
#[13] "Table_6_df.txt"  "Table_7_df.txt"  "Table_8_df.txt"  "Table_9_df.txt" 
...
#Notes <- c("[note 1]", rep(NA_character_, 3), "[note 2]", rep(NA_character_, 3))
#Table_1_df <- cbind(Table_1_df, Notes)
#Table_1_df
...
##### Add Notes - after correcting the custom sheets in a11ytables ####
#This works so now I will duplicate this below and attempt to correct the code so it includes all the tables required
#my_wb10<-my_wb
...
#for(i in 4:19){
 #openxlsx::setColWidths(my_wb1, 
 #                        sheet = i, 
 #                       widths = "auto")}

##openxlsx::saveWorkbook(my_wb1, "JAC Module Tables Widths 002.xlsx")


#table borders
#https://www.bing.com/search?q=table+border+workbook+xlsx+r&qs=n&form=QBRE&sp=-1&ghc=1&lq=0&pq=table+border+workbook+xlsx+r&sc=11-28&sk=&cvid=E779E3DB8B3343FFAA66681F95BD7AAE&ghsh=0&ghacc=0&ghpl=
#add commas to numbers - this will convert numbers to a string
#https://search.r-project.org/CRAN/refmans/broman/html/add_commas.html

#wb2 <- loadWorkbook("JAC Module Tables 002.xlsx")
#formatted_df <- prettyNum(wb2, big.mark = ",")
#prettyNum(r, big.mark = ",")
#openxlsx::getSheetNames("wb_widths1.xlsx")
